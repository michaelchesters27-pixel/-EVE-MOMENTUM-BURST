...
5. Keep:
   ...
   - `AUTO_ENABLED=true`
   - `DATA_DIR=/data`
6. Wait until the dashboard shows `v2.0.3`.

## MetaEditor

1. Open `mt5/EVE_Momentum_Burst_EA_v2.03.mq5`.
2. Press F7.
...
3. Attach `EVE_Momentum_Burst_EA_v2.03`.
4. Set:
